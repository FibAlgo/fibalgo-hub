...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { href: '/library', label: 'Library', isFireText: false },
    { href: '#pricing', label: 'Pricing', isFireText: false },
  ];
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {/* Logo - Left */}
            <Link href="/" style={{ position: 'absolute', left: isMobile ? '0.75rem' : '1.5rem', display: 'flex', alignItems: 'center', textDecoration: 'none' }}>
              <Image
                src="/logo-white.svg"
                alt="FibAlgo Logo"
                ...
                return (
                  <Link
                    ...
                    style={{
                      ...
                      textDecoration: 'none',
                      whiteSpace: 'nowrap',
                      padding: isMobile ? '0.35rem 0.5rem' : '0.6rem 1.25rem',
                      borderRadius: isMobile ? '8px' : '10px',
                      transition: 'all 0.2s ease',
                      background: isFireText 
                        ? 'linear-gradient(90deg, #FFD700, #FF8C00, #FF6347, #FFD700)'
                        : 'transparent',
                      backgroundSize: isFireText ? '200% auto' : 'auto',
                      WebkitBackgroundClip: isFireText ? 'text' : undefined,
                      backgroundClip: isFireText ? 'text' : undefined,
                      animation: isFireText ? 'gradientShift 3s ease infinite' : 'none',
                      display: 'flex',
                      alignItems: 'center',
                      gap: '0.5rem',
                    }}
            ...
            <div style={{ position: 'absolute', right: isMobile ? '0.75rem' : '1.5rem', display: 'flex', alignItems: 'center', gap: isMobile ? '0.35rem' : '0.75rem' }}>
              {isLoggedIn ? (
                /* Profile Menu */
                <div style={{ position: 'relative' }}>
                  ...
                  >
                    {userAvatarUrl ? (
                      ...
                      <Shield style={{ width: isMobile ? '16px' : '22px', height: isMobile ? '16px' : '22px', color: '#0A0A0F' }} />
                    ) : (
                      <User style={{ width: isMobile ? '16px' : '22px', height: isMobile ? '16px' : '22px', color: '#0A0A0F' }} />
                    )}
                  </button>
