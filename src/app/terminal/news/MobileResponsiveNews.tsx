...
import { AIAnalysis } from '@/components/news/AIAnalysisCard';
          ...
          <div className="mobile-sentiment-card">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem', position: 'relative', zIndex: 1, flexWrap: 'wrap', gap: '0.75rem' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                ...
                <div>
                  <h3 style={{ color: '#fff', fontSize: '1rem', fontWeight: 700, margin: 0 }}>Market Sentiment</h3>
                  <span style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.65rem' }}>Real-time market mood</span>
                </div>
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', position: 'relative', zIndex: 1 }}>
                ...
                <div style={{ padding: '0 0.25rem' }}>
                  <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
                    <span style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.5)' }}>Bearish</span>
                    <span style={{ fontSize: '0.7rem', color: 'rgba(255,255,255,0.5)' }}>Bullish</span>
                  </div>
                  <div style={{
                    height: '10px',
                    borderRadius: '5px',
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '0.5rem' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                      ...
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.7rem' }}>Bullish</span>
                    </div>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                      ...
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.7rem' }}>Bearish</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                      ...
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.7rem' }}>Neutral</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.25rem' }}>
                      ...
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.7rem' }}>Impact</span>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem' }}>
