      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div className="markets-content">
          ...
          <div ref={containerRef} className="markets-main-layout">
            ...
            >
              {activeTab === 'crypto' ? 'Name' : activeTab === 'forex' ? 'Pair' : activeTab === 'stocks' ? 'Company' : activeTab === 'commodities' ? 'Commodity' : 'Index'}
            ...
            >
              24h % {sortBy === 'change24h' && (sortOrder === 'desc' ? '↓' : '↑')}
            </div>
            <div 
              style={{ 
            ...
            >
              {activeTab === 'crypto' ? 'Volume (24h)' : activeTab === 'forex' ? 'Volume' : activeTab === 'commodities' ? 'Unit' : '24h High'}
              {(sortBy === 'volume24h' || (activeTab === 'commodities' && sortBy === 'price')) && (sortOrder === 'desc' ? ' ↓' : ' ↑')}
            </div>
            {activeTab === 'crypto' && (
              <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.75rem', fontWeight: 600, textAlign: 'center' }}>24h Range</div>
            )}
          </div>
          ...
          >
            ...
            <div style={{
              ...
              <div style={{ 
                ...
                <Activity size={18} />
                {activeTab === 'crypto' ? 'Crypto Market Overview' : 
                 activeTab === 'forex' ? 'Forex Market Overview' :
                 activeTab === 'stocks' ? 'Stock Market Overview' :
                 activeTab === 'commodities' ? 'Commodities Overview' : 'Indices Overview'}
              </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                {activeTab === 'crypto' && (
                  <>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.5rem', background: 'rgba(0,0,0,0.2)', borderRadius: '8px' }}>
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.8rem' }}>Total Market Cap</span>
                      <span style={{ color: '#fff', fontWeight: 600, fontSize: '0.9rem' }}>
                        ${(coins.reduce((acc, c) => acc + c.marketCap, 0) / 1e12).toFixed(2)}T
                      </span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.5rem', background: 'rgba(0,0,0,0.2)', borderRadius: '8px' }}>
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.8rem' }}>24h Volume</span>
                      <span style={{ color: '#fff', fontWeight: 600, fontSize: '0.9rem' }}>
                        ${(coins.reduce((acc, c) => acc + c.volume24h, 0) / 1e9).toFixed(2)}B
                      </span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.5rem', background: 'rgba(0,0,0,0.2)', borderRadius: '8px' }}>
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.8rem' }}>BTC Dominance</span>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.5rem', background: 'rgba(0,0,0,0.2)', borderRadius: '8px' }}>
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.8rem' }}>ETH Dominance</span>
                    ...
                    {fearGreedIndex && (
                      <div style={{ 
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '2px' }}>
                          <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.75rem' }}>Fear & Greed Index</span>
                          <span style={{ 
                ...
                {activeTab === 'forex' && (
                  <>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.5rem', background: 'rgba(0,0,0,0.2)', borderRadius: '8px' }}>
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.8rem' }}>Pairs Tracked</span>
                ...
                {activeTab === 'stocks' && (
                  <>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.5rem', background: 'rgba(0,0,0,0.2)', borderRadius: '8px' }}>
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.8rem' }}>Stocks Tracked</span>
                      <span style={{ color: '#fff', fontWeight: 600, fontSize: '0.9rem' }}>{stocks.length}</span>
                    </div>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.5rem', background: 'rgba(0,0,0,0.2)', borderRadius: '8px' }}>
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.8rem' }}>Avg Change</span>
                ...
                {activeTab === 'indices' && (
                  <>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0.5rem', background: 'rgba(0,0,0,0.2)', borderRadius: '8px' }}>
                      <span style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.8rem' }}>Indices Tracked</span>
