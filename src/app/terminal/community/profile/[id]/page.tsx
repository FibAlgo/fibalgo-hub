    ...
    <div className="profile-container">
      ...
      <header className="profile-header">
        ...
        <div className="header-info">
          ...
          <span>{profile.posts_count || 0} gönderi</span>
        </div>
        {isOwnProfile && (
      ...
      <div className="posts-list">
        {posts.length === 0 ? (
          <div className="empty-state">
            ...
            <p>{isOwnProfile ? 'İlk gönderini paylaş!' : 'Bu kullanıcı henüz gönderi paylaşmamış.'}</p>
          </div>
        ) : (
          posts.map(post => (
          ...
          <div className="edit-modal" onClick={e => e.stopPropagation()}>
            <div className="modal-header">
              ...
              <button 
                ...
                disabled={saving}
              >
                {saving ? <Loader2 size={18} className="spin" /> : 'Kaydet'}
              </button>
            </div>
