...
export const metadata: Metadata = {
  ...
  description: 'FibAlgo trader community is coming soon. Connect with AI-powered traders, share strategies, and grow together.',
  robots: {
    index: false,
    follow: true,
  },
    ...
    <main style={{ minHeight: '100vh', width: '100%', overflowX: 'hidden', position: 'relative' }}>
      ...
      <section style={{
        ...
        <p style={{
          ...
          We&apos;re building a space where traders connect, share strategies, and grow together — powered by AI insights.
        </p>
        ...
        <div style={{
          ...
          {['Trading Discussions', 'Strategy Sharing', 'AI Signal Alerts', 'Leaderboards'].map((feature) => (
