        ...
        {featuredPost && (
          <Link href={`/blog/${featuredPost.slug}`} style={{ textDecoration: 'none', display: 'block', marginBottom: '2.5rem' }}>
            <article className="blog-card-hover" style={{
              ...
              {/* Cover image area */}
              <div style={{
                background: getCoverGradient(featuredPost.tags[0], 0),
                padding: '3rem 2.5rem',
                display: 'flex',
                ...
                {/* Large category icon */}
                <span style={{ fontSize: '4rem', marginBottom: '1rem', filter: 'drop-shadow(0 0 20px rgba(0,245,255,0.3))' }}>
                  {getCatIcon(featuredPost.tags[0])}
                </span>
                <span style={{
            ...
            return (
              <Link key={post.slug} href={`/blog/${post.slug}`} style={{ textDecoration: 'none' }}>
                <article className="blog-card-hover" style={{
                  ...
                  {/* Card cover */}
                  <div style={{
                    background: getCoverGradient(post.tags[0], i + 1),
                    padding: '2rem 1.5rem',
                    position: 'relative',
                    display: 'flex',
                    alignItems: 'center',
                    ...
                    <span style={{ fontSize: '2.5rem', zIndex: 1, filter: 'drop-shadow(0 0 12px rgba(0,245,255,0.2))' }}>
