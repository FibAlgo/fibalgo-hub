        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          {hasActual && surpriseDirection && (
            <span style={{
              ...
              {surpriseDirection === 'beat' ? t('beat') : surpriseDirection === 'miss' ? t('miss') : t('inline')}
            </span>
          )}
          {/* AI Analysis Badge */}
          {showBadge && (
            <span style={{
              ...
              <Brain size={10} />
              {isAnalyzed ? t('agentAnalyzed') : t('agentReady')}
            </span>
          )}
        </div>
      </div>
        ...
        <div style={{ 
          ...
          {hasActual && (
            <div style={{
              ...
              <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.6rem', marginBottom: '4px', letterSpacing: '0.8px', fontWeight: 600 }}>{t('actual')}</div>
              <div style={{ 
                color: surpriseDirection === 'beat' ? '#22C55E' :
          ...
          {event.forecast && (
            <div style={{
              ...
              <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.6rem', marginBottom: '4px', letterSpacing: '0.8px', fontWeight: 600 }}>{t('forecast')}</div>
          ...
          {event.previous && (
            <div style={{
              ...
              <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.6rem', marginBottom: '4px', letterSpacing: '0.8px', fontWeight: 600 }}>{t('previousLabel')}</div>
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '10px' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <span style={{
            ...
            {hasActual ? (minutesAgo ? t('mAgo', { count: minutesAgo }) : t('released')) : t('live')}
          </span>
        </div>
        ...
        {hasActual && surpriseDirection && (
          <span style={{
            ...
            {surpriseDirection === 'beat' ? t('above') : surpriseDirection === 'miss' ? t('below') : t('inLineResult')}
          </span>
        )}
      </div>
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.6rem', marginBottom: '4px', letterSpacing: '0.5px' }}>{t('actual')}</div>
          {hasActual ? (
        ...
        <div style={{
          ...
          <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.6rem', marginBottom: '4px', letterSpacing: '0.5px' }}>{t('forecast')}</div>
        ...
        <div style={{
          ...
          <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.6rem', marginBottom: '4px', letterSpacing: '0.5px' }}>{t('previousLabel')}</div>
      ...
      >
        ...
        {expanded ? t('hideAnalysis') : t('showAnalysis')}
      </button>
        ...
        <div style={{ position: 'relative', marginTop: '12px', paddingTop: '12px', borderTop: '1px solid rgba(255,255,255,0.1)' }}>
          ...
          {analysis.summary && (
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '6px' }}>
                ...
                <span style={{ color: '#00F5FF', fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.5px' }}>{t('fibalgoAnalysis')}</span>
              </div>
          ...
          {analysis.key_takeaway && (
            <div style={{
              ...
              <div style={{ color: '#A78BFA', fontSize: '0.7rem', fontWeight: 700, marginBottom: '4px' }}>{t('keyTakeaway')}</div>
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', gap: '16px', marginBottom: '12px', fontSize: '0.8rem' }}>
        {event.forecast && (
          <div>
            <span style={{ color: 'rgba(255,255,255,0.5)' }}>{t('forecastColon')} </span>
            <span style={{ color: '#fff', fontWeight: 600 }}>{event.forecast}</span>
          </div>
        )}
        {event.previous && (
          <div>
            <span style={{ color: 'rgba(255,255,255,0.5)' }}>{t('previousColon')} </span>
      ...
      >
        {expanded ? <ChevronUp size={14} /> : <ChevronDown size={14} />}
        {expanded ? t('hidePlaybook') : t('showPlaybook')}
      </button>
      ...
      {expanded && analysis?.scenarioPlaybook && (
        <div style={{ position: 'relative', marginTop: '12px', paddingTop: '12px', borderTop: '1px solid rgba(0,245,255,0.2)' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '6px', marginBottom: '10px' }}>
            ...
            <span style={{ color: '#F59E0B', fontSize: '0.7rem', fontWeight: 700, letterSpacing: '0.5px' }}>{t('scenarioPlaybook')}</span>
          </div>
            ...
            >
              ...
              {scenario.trades && scenario.trades.length > 0 ? (
                ...
                <span style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.75rem', fontStyle: 'italic' }}>
                  {t('noTradeWithReason', { reason: scenario.reason || t('noEdge') })}
                </span>
              )}
            </div>
          ))}
                ...
                >
                  <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    ...
                    <span style={{ textTransform: 'uppercase' }}>
                      {countryFilter === 'all' ? t('filterAll') : countryFilter}
                    </span>
                  </span>
          ...
          <div style={{ padding: '16px 0' }}>
            {isLoading && sortedEvents.length === 0 ? (
              <div className="mobile-calendar-empty-state">
                ...
                <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.85rem' }}>{t('loadingEvents')}</div>
              </div>
            ) : sortedEvents.length === 0 ? (
              <div className="mobile-calendar-empty-state">
                <CalendarIcon size={40} color="rgba(255,255,255,0.2)" style={{ marginBottom: '12px' }} />
                <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.85rem' }}>
                  {calendarEmptyMessage || t('noEventsForDay')}
                </div>
              </div>
            ) : (
        ...
        <div className={`mobile-calendar-tab-content ${activeTab === 'agent-analyze' ? 'current' : ''}`}>
          <div style={{ padding: '16px 0' }}>
            ...
            {loadingAnalyses ? (
              <div className="mobile-calendar-empty-state">
                <Loader2 size={32} color="#00F5FF" style={{ animation: 'spin 1s linear infinite', marginBottom: '12px' }} />
                <div style={{ color: 'rgba(255,255,255,0.5)', fontSize: '0.85rem' }}>{t('loadingAnalyses')}</div>
              </div>
            ) : totalAnalyses === 0 ? (
              <div className="mobile-calendar-empty-state">
                    ...
                    <div style={{ marginBottom: '24px' }}>
                      ...
                      >
                        ...
                        {eventAnalyses.isDemo && (
                          <span style={{ background: 'rgba(245,158,11,0.2)', color: '#F59E0B', fontSize: '0.55rem', fontWeight: 700, padding: '2px 4px', borderRadius: '4px' }}>{t('demo')}</span>
                        )}
                        <div style={{ flex: 1 }} />
                        <ChevronDown 
                          size={16} 
          ...
          <div style={{ padding: '16px' }}>
            {mobileModalLoading ? (
              <div style={{ 
                ...
                <div style={{ color: 'rgba(255,255,255,0.6)', fontSize: '0.9rem' }}>{t('loadingAnalysis')}</div>
              </div>
            ) : (
              <>
