...
const mobileNavItems = [
  { icon: Newspaper, labelKey: 'news' as const, href: '/terminal/news' },
  { icon: LineChart, labelKey: 'chart' as const, href: '/terminal/chart' },
  { icon: BarChart3, labelKey: 'marketsTab' as const, href: '/terminal/markets' },
  { icon: Calendar, labelKey: 'calendarTab' as const, href: '/terminal/calendar' },
  { icon: Menu, labelKey: 'menu' as const, href: '#menu', isMenu: true },
];
...
const drawerMenuItems = [
  ...
  { icon: CreditCard, labelKey: 'billing' as const, href: '/dashboard?tab=billing' },
