...
export default function MobileResponsiveMarkets({
  ...
  const t = useTranslations('mobileMarkets');
  ...
  return (
    <div className="mobile-markets-container">
      ...
      <div className="mobile-markets-content">
        ...
        >
          <Activity size={16} />
          {showIndicators ? t('hideMarketOverview') : t('showMarketOverview')}
          ...
          <div className="mobile-indicators-panel" style={!isPremium ? { filter: 'blur(6px)', pointerEvents: 'none', userSelect: 'none' } : undefined}>
            <div className="mobile-indicator-card">
              <div className="mobile-indicator-header">
                <Activity size={18} />
                {activeTab === 'crypto' ? t('cryptoMarket') : 
                 activeTab === 'forex' ? t('forexMarket') :
                 activeTab === 'stocks' ? t('stockMarket') :
                 activeTab === 'commodities' ? t('commodities') : t('indices')}
              </div>
              
              {activeTab === 'crypto' && (
                <>
                  <div className="mobile-indicator-row">
                    <span className="mobile-indicator-label">{t('totalMarketCap')}</span>
                    <span className="mobile-indicator-value">
                      ${(coins.reduce((acc, c) => acc + c.marketCap, 0) / 1e12).toFixed(2)}T
                    </span>
                  </div>
                  <div className="mobile-indicator-row">
                    <span className="mobile-indicator-label">{t('btcDominance')}</span>
                  ...
                  {fearGreedIndex && (
                    <div className="mobile-indicator-row" style={{ 
                      ...
                      <span className="mobile-indicator-label">{t('fearGreed')}</span>
              ...
              {activeTab !== 'crypto' && (
                <div className="mobile-indicator-row">
                  <span className="mobile-indicator-label">{t('assetsTracked')}</span>
                  <span className="mobile-indicator-value">
