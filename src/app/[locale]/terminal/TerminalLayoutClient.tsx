...
const menuItems = [
  { icon: Home, labelKey: 'home' as const, href: '/terminal' },
  { icon: Bell, labelKey: 'notifications' as const, href: '#notifications', isNotification: true },
  { icon: Newspaper, labelKey: 'newsFeed' as const, href: '/terminal/news' },
  { icon: BarChart2, labelKey: 'marketsTab' as const, href: '/terminal/markets' },
  { icon: Calendar, labelKey: 'calendarTab' as const, href: '/terminal/calendar' },
  { icon: Activity, labelKey: 'signals' as const, href: '/terminal/signals', isLocked: true },
  { icon: Zap, labelKey: 'premium' as const, href: '/#pricing', isPremium: true },
  { icon: BookOpen, labelKey: 'library' as const, href: '/library' },
  { icon: GraduationCap, labelKey: 'education' as const, href: '/education' },
  { icon: Users, labelKey: 'community' as const, href: '/terminal/community', isLocked: true },
  { icon: Bot, labelKey: 'agent' as const, href: '/terminal/agent', isLocked: true },
  { icon: User, labelKey: 'profile' as const, href: '/dashboard?tab=profile' },
];
...
export default function TerminalLayout({
  ...
  const t = useTranslations('terminalLayoutNav');
  ...
  return (
    <TerminalProvider value={terminalContextValue}>
      ...
      <aside className="terminal-sidebar">
        ...
        >
          <HelpCircle size={16} />
          <span className="menu-label">{t('helpCenter')}</span>
        </Link>
            ...
            <div className="premium-banner-desktop" style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '2rem', position: 'relative', zIndex: 1 }}>
                <div style={{ textAlign: 'right' }}>
                  ...
                  <div style={{ color: 'rgba(255,255,255,0.4)', fontSize: '0.875rem' }}>{t('premiumAccess')}</div>
                </div>
                <Link
                  href="/#pricing"
                  style={{
