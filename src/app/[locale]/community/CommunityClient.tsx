    ...
    <div className="community-container">
      ...
      <main className="main-content">
        ...
        {user ? (
            ...
            <div className="composer-input">
              ...
              <div className="composer-actions">
                <div className="composer-tools">
                  <button className="tool-btn" title={t('addImage')}>
                    <ImageIcon size={20} />
                  </button>
                </div>
                <div className="composer-right">
                  ...
                  >
                    {posting ? <Loader2 size={18} className="spin" /> : t('share')}
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="guest-prompt">
            <p>
              <Link href="/login?redirectTo=/community">{t('guestLogin')}</Link>
              {' · '}
              <Link href="/signup">{t('guestSignup')}</Link>
            </p>
          </div>
        )}
        ...
        <div className="posts-feed">
          {loading ? (
            ...
            <div className="empty-feed">
              <Users size={48} />
              <h3>{t('noPosts')}</h3>
              <p>{user ? t('beFirstPost') : t('noPostsGuest')}</p>
            </div>
          ) : (
            posts.map(post => (
      ...
      <aside className="sidebar right-sidebar">
        ...
        <div className="widget trending-widget">
          <h3><TrendingUp size={18} /> {t('trendsTitle')}</h3>
          <div className="trend-item">
            <span className="trend-category">{t('trendTrading')}</span>
            <span className="trend-topic">#FibAlgo</span>
            <span className="trend-count">{t('trendPosts', { count: '1,234' })}</span>
          </div>
          <div className="trend-item">
            <span className="trend-category">{t('trendFinance')}</span>
            <span className="trend-topic">#Bitcoin</span>
            <span className="trend-count">{t('trendPosts', { count: '892' })}</span>
          </div>
          <div className="trend-item">
            <span className="trend-category">{t('trendInvestment')}</span>
            <span className="trend-topic">#TeknikAnaliz</span>
            <span className="trend-count">{t('trendPosts', { count: '567' })}</span>
          </div>
        </div>

        {/* Suggested Users */}
        <div className="widget suggestions-widget">
          <h3><Users size={18} /> {t('suggestedUsers')}</h3>
          {suggestedUsers.map(suggestedUser => (
            <div key={suggestedUser.id} className="suggested-user">
              ...
              <div className="suggested-info">
                ...
                <span className="suggested-bio">{suggestedUser.bio || t('defaultBio')}</span>
              </div>
