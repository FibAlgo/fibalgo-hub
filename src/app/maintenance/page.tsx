        ...
        <div style={{ display: 'flex', gap: 14, alignItems: 'flex-start' }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <p style={{ color: 'var(--text-secondary)', fontSize: '0.95rem' }}>
              We’re currently experiencing a temporary connectivity issue with our infrastructure provider. Login and data-driven pages are temporarily unavailable.
            </p>
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 10, alignItems: 'center', justifyContent: 'space-between' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                  ...
                  <div style={{ fontSize: '0.95rem' }}>
                    {health?.maintenance === false ? 'Online' : 'Maintenance'}
                  </div>
                </div>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                  <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Last check</div>
            ...
            <p style={{ marginTop: 14, fontSize: '0.8rem', color: 'rgba(255,255,255,0.55)' }}>
              This page checks automatically and will close once services are back online.
            </p>
          </div>
        </div>
      </div>
