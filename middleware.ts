...
export async function middleware(request: NextRequest) {
  ...
  // If maintenance is active, redirect all pages to /maintenance.
  ...
  // If maintenance is not active anymore, avoid leaving users stuck on /maintenance.
  ...
  if (pathname.startsWith('/terminal')) {
    ...
    // Anonymous users: allow limited preview, then require login
